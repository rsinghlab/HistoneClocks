...
# Read the gap data and filter out the observations related to cancer
...
# Concatenate the gene and gap data, and filter out the observations related to cancer
...
# Read the HM27 450 CpG data and filter out the observations related to cancer
...
# Read the Horvath CpGs, subset the data, and filter out the observations related to cancer
...
adata_genes.write_h5ad('results/adata_genes.h5ad')

# Perform nested cross-validation on the gap data and save the results
adata_gaps = nested_cross_validation(
    adata=adata_gaps, 
    n_folds=10,
    hyperparams=[0.1, 0.05, 0.01, 0.005, 0.001],
)
adata_gaps.write_h5ad('results/adata_gaps.h5ad')

# Perform nested cross-validation on the whole genome data and save the results
adata_whole_genome = nested_cross_validation(
    adata=adata_whole_genome, 
    n_folds=10,
    hyperparams=[0.1, 0.05, 0.01, 0.005, 0.001],
)
adata_whole_genome.write_h5ad('results/adata_whole_genome.h5ad')

# Perform nested cross-validation on the HM27 450 CpGs data and save the results
adata_hm27_450_cpgs = nested_cross_validation(
    adata=adata_hm27_450_cpgs, 
    n_folds=10,
    hyperparams=[0.1, 0.05, 0.01, 0.005, 0.001],
)
adata_hm27_450_cpgs.write_h5ad('results/adata_hm27_450_cpgs.h5ad')

# Perform nested cross-validation on the Horvath CpGs data and save the results
adata_horvath_cpgs = nested_cross_validation(
    adata=adata_horvath_cpgs, 
    n_folds=10,
    hyperparams=[0.1, 0.05, 0.01, 0.005, 0.001],
)
adata_horvath_cpgs.write_h5ad('results/adata_horvath_cpgs.h5ad')
