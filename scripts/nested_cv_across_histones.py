...
def nested_cross_validation_across_histones(adata, n_folds=5, hyperparams=[0.05, 0.01]):
    """
...
adata_genes_across_histones = nested_cross_validation_across_histones(
    adata=adata_genes, 
    n_folds=10,
...
adata_genes_across_histones.write_h5ad('results/adata_genes_across_histones.h5ad')
